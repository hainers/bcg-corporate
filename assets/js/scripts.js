...
var modalContent = {
    ...
    'cvbankas': {
        'content': '<p class="mb-5">Jobs classifieds portal in Lithuania.</p><p class="mb-4">Facts about CVbankas.lt:</p><ul class="bcg-big-list"><li class="bcg-big-list__item">Leading jobs classifieds portal in Lithuania based on number of listings as of 16 March 2021, average number of monthly visits in 2020 and average monthly time on site per visit in 2020 according to <a href="https://www.similarweb.com/" target="_blank">SimilarWeb</a>.</li><li class="bcg-big-list__item">Over 2 million monthly visits on average during 2020 according to <a href="https://www.similarweb.com/" target="_blank">SimilarWeb</a>.</li><li class="bcg-big-list__item">Résumé database with over 700,00 résumés as of 16 March 2021.</li></ul><p class="mt-5 mb-2"><a href="https://cvbankas.lt/" target="_blank">Visit CVbankas.lt</a></p>'
    },
    'kainos': {
