...
var modalContent = {
    'aruodas': {
        'content': '<p class="mb-5">Real estate classifieds portal in Lithuania.</p><p class="mb-4">Facts about Aruodas.lt:</p><ul class="bcg-big-list"><li class="bcg-big-list__item">Leading real estate classifieds portal in Lithuania based on number of listings as of 16 March 2021, average number of monthly visits in 2020 and average monthly time on site per visit in 2020 (Source: SimilarWeb).</li><li class="bcg-big-list__item">Over 6 million monthly visits on average during 2020 (Source: Google Analytics).</li></ul><p class="mt-5 mb-2"><a href="https://aruodas.lt/" target="_blank">Visit aruodas</a></p>'
    },
    'auto24': {
    ...
    'autoplius': {
        'content': '<p class="mb-5">Automotive classifieds portal in Lithuania.</p><p class="mb-4">Facts about Autoplius.lt:</p><ul class="bcg-big-list"><li class="bcg-big-list__item">Leading automotive classifieds portal Lithuania based on number of listings as of 16 March 2021, average number of monthly visits in 2020 and average monthly time on site per visit in 2020 (Source: SimilarWeb)</li><li class="bcg-big-list__item">Over 19 million monthly visits in average during 2020 (Source: Google Analytics).</li></ul><p class="mt-5 mb-2"><a href="https://autoplius.lt/" target="_blank">Visit autoplius</a></p>'
    },
    'city24ee': {
        'content': '<p class="mb-5">Real estate classifieds portal in Estonia.</p><p class="mb-4">Facts about City24.ee:</p><ul class="bcg-big-list"><li class="bcg-big-list__item">No. 2 portal in Estonia based on average number of monthly visits in 2020 and average monthly time on site per visit in 2020 (Source: SimilarWeb)</li><li class="bcg-big-list__item">User-friendly portal with interesting and high-quality content and innovative functionalities.</li><li class="bcg-big-list__item">It has been a home for homes since 2000.</li></ul><p class="mt-5 mb-2"><a href="https://city24.ee/" target="_blank">Visit City24.ee</a></p>'
    },
    'city24lv': {
    ...
    'cvbankas': {
        'content': '<p class="mb-5">Jobs classifieds portal in Lithuania.</p><p class="mb-4">Facts about CVbankas.lt:</p><ul class="bcg-big-list"><li class="bcg-big-list__item">Leading jobs classifieds portal in Lithuania based on number of listings as of 16 March 2021, average number of monthly visits in 2020 and average monthly time on site per visit in 2020 (Source: SimilarWeb).</li><li class="bcg-big-list__item">Over 2 million monthly visits on average during 2020 (Source: SimilarWeb).</li><li class="bcg-big-list__item">Résumé database with over 700,00 résumés as of 16 March 2021.</li></ul><p class="mt-5 mb-2"><a href="https://cvbankas.lt/" target="_blank">Visit CVbankas.lt</a></p>'
    },
    'kainos': {
        'content': '<p class="mb-5">Price comparison portal in Lithuania.</p><p class="mb-4">Facts about Kainos.lt:</p><ul class="bcg-big-list"><li class="bcg-big-list__item">No.2 portal in Lithuania based on average number of monthly visits in 2020 and average monthly time on site per visit in 2020 (Source: SimilarWeb).</li><li class="bcg-big-list__item">Over 1.5 million monthly visits on average during 2020 (Source: Google Analytics)</li><li class="bcg-big-list__item">As of 16 March 2021, Kainos.lt worked with over 300 e-shops and showed over 2 million products.</li><li class="bcg-big-list__item">The product-related price information, including price and stock status is updated every 30 minutes.</li></ul><p class="mt-5 mb-2"><a href="https://kainos.lt/" target="_blank">Visit Kainos.lt</a></p>'
    },
    'kuldnebors': {
    ...
    'kv': {
        'content': '<p class="mb-5">Real estate classifieds portal in Estonia.</p><p class="mb-4">Facts about KV.ee:</p><ul class="bcg-big-list"><li class="bcg-big-list__item">Leading real estate portal in Estonia based on number of listings as of 16 March 2021, average number of monthly visits in 2020 and average monthly time on site per visit in 2020 (Source: SimilarWeb).</li><li class="bcg-big-list__item">KV.ee\'s mission since 1999 has been to inspire people to live better.</li></ul><p class="mt-5 mb-2"><a href="https://kv.ee/" target="_blank">Visit KV</a></p>'
    },
    'osta': {
        'content': '<p class="mb-5">Marketplace in Estonia Osta.ee</p><p class="mb-4">Facts about Osta.ee:</p><ul class="bcg-big-list"><li class="bcg-big-list__item">Leading marketplace in Estonia based on number of listings as of 16 March 2021, average number of monthly visits in 2020 and average monthly time on site per visit in 2020 (Source: SimilarWeb).</li><li class="bcg-big-list__item">As of 18 March 2021, there were over 400,000 registered users.</li><li class="bcg-big-list__item">Offers the ability to buy via auctions or “Buy Now” offers.</li><li class="bcg-big-list__item">Auctions organized by many state agencies and municipalities.</li></ul><p class="mt-5 mb-2"><a href="https://osta.ee/" target="_blank">Visit Osta</a></p>'
    },
    'paslaugos': {
    ...
    'skelbiu': {
        'content': '<p class="mb-5">Generalist classifieds portal in Lithuania.</p><p class="mb-4">Facts about Skelbiu.lt:</p><ul class="bcg-big-list"><li class="bcg-big-list__item">Leading generalist classifieds portal in Lithuania based on number of listings as of 16 March 2021, average number of monthly visits in 2020 and average monthly time on site per visit in 2020 (Source: SimilarWeb). </li><li class="bcg-big-list__item"> Over 22 million monthly visits on average during 2020 (Source: Google Analytics).</li><li class="bcg-big-list__item">Listings moderated by artificial Intelligence and human resources for quality control.</li></ul><p class="mt-5 mb-2"><a href="https://skelbiu.lt/" target="_blank">Visit Skelbiu</a></p>'
    },
};
